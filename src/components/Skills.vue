...
const categories = [
    ...
    },
    {
        ...
        skills: ["React", "Vue.js", "React Native", "Flutter", "Expo", "Tailwind CSS", "OpenGL"]
    },
    {
        title: "AI",
        color: "teal",
    ...
    },
    {
        ...
        skills: ["Stripe", "Plaid", "PayPal", "SendGrid", "Resend"]
    },
    {
        title: "Cloud & DevOps",
        color: "orange",
    ...
    },
    {
        ...
        skills: ["Microservices", "Event-Driven Architecture", "System Design", "Serverless", "Technical Leadership", "Concurrency", "Memory Management", "Multithreading", "SIMD", "Low-level Optimization"]
    }
]
</script>
