        ...
        <div v-else class="mb-12 min-h-[500px]">
            ...
            <div class="flex justify-center mb-6 animate-fade-in-up" v-if="!loading">
                <div class="inline-flex rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden text-sm font-medium">
                    <button @click="sortBy = 'stars'" :aria-pressed="sortBy === 'stars'"
                        class="px-4 py-2 flex items-center gap-1.5 transition-colors cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/60 focus-visible:ring-inset"
                    ...
                    <button @click="sortBy = 'updated'" :aria-pressed="sortBy === 'updated'"
                        class="px-4 py-2 flex items-center gap-1.5 transition-colors cursor-pointer border-l border-gray-200 dark:border-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/60 focus-visible:ring-inset"
            ...
            <div class="flex flex-wrap justify-center gap-2 mb-8 animate-fade-in-up delay-100" v-if="!loading">
                <button @click="selectedLanguage = 'All'"
                    class="px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/60"
