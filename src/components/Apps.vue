                ...
                <transition-group name="list">
                    <div v-for="app in visibleApps" :key="app.name"
                        ...
                        <div class="p-6 flex-1 flex flex-col">
                            ...
                            <!-- Action Links -->
                            <div v-if="app.playStore || app.link"
                                class="flex flex-wrap gap-2 pt-4 border-t border-gray-100 dark:border-gray-700 mt-4">
                                <a v-if="app.playStore" :href="app.playStore" target="_blank" rel="noopener"
                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded-lg transition-colors shadow-sm">
                                ...
                                <a v-if="app.link" :href="app.link" target="_blank" rel="noopener"
                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg transition-colors border"
                                    :class="app.playStore
                                        ? 'bg-transparent text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700'
                                        : 'bg-gray-800 dark:bg-gray-700 text-white border-gray-800 dark:border-gray-600 hover:bg-gray-700 dark:hover:bg-gray-600'">
                                    <svg v-if="app.category === 'Web'" class="h-3.5 w-3.5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                    </svg>
                                    <IconGitHub v-else class="h-3.5 w-3.5" />
                                    {{ app.category === 'Web' ? 'Visit Site' : 'GitHub' }}
                                </a>
                            </div>
                        </div>
                    </div>
